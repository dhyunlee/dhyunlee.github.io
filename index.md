...
<div class="profile-header">
  ...
  <div class="profile-bio">
    ...
    <p>I work on the reliability of Autonomous Driving systems. My research starts from a simple question: when a hardware fault corrupts a machine learning model inside a autonomous driving system, does the car actually fail?</p>
    <p>A vision-language-action (VLA) model runs multiple inferences per task inside a closed feedback loop, and that loop absorbs many errors on its own. I study how the fault injections affect on the open-loop and closed-loop system, faults it absorbs, which it cannot.</p>
  </div>
</div>
...
- Fault tolerance for closed-loop autonomous driving system
